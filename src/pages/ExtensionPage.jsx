  ...
  return (
    <div className='m-[2%] my-[30px] pb-[30px]'>
      ...
      <p className='mt-[20px]'>
        ...
        simply fill out the form as you would in our main application, the click
        <span className='font-bold'> "Add job" </span> to complete the process.
      </p>
      <div className=' mt-[20px]'>
        <img
          src={example1}
          alt='example image'
          className='w-[200px] h-[240px] mt-[20px] '
        />
        <img
          src={example2}
          alt='example image 2'
      ...
      <p className='mt-[20px]'>
        ...
        Chrome extensions, so AppliSnap and most other Chrome extensions should
        be compatible.
      </p>
